...
import {flip, random} from "../utils.js";
...
export function createStar(lightPos = new Vector2(0.39, 0.7),
                           lightIntensity = 0.1,
                           rotationSpeed = 0.01,
                           rotation = 0.0,
                           color = null) {

    const palette = color ? `src/pixel-planets/src/colorScheme/starPalette/${color}Palette.png` : "src/pixel-planets/src/colorScheme/starPalette/purple2Palette.png"
    ...
    const planetMaterial = new ShaderMaterial({
        uniforms: {
            ...
            seed: {value: flip() ? random() * 10 : random() * 100},
            time: {value: 0.0}
        },
